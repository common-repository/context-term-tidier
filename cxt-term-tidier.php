...
function cxt_plugin_page(  ) {
        ...
        <div class="wrap">
                ...
                <div class="notice notice-info is-dismissible">
                    <p>Source taxonomy: '<?php echo $source_taxonomy_obj->labels->singular_name; ?>' ('<?php echo $source_taxonomy_slug; ?>') set in Context Terms Tidier Settings [<a href="<?php echo admin_url(); ?>options-general.php?page=magic-terms-settings">Change</a>] (<?php echo number_format(wp_count_terms( $source_taxonomy_slug )); ?> terms).</p>
                </div>
                ...
                <form id="cxt-form" action="" method="POST">
                    <div>
                        ...
                        <img src="<?php echo admin_url(); ?>images/wpspin_light.gif" class="waiting" id="cxt-loading" style="display:none">
                    </div>
                </form>
